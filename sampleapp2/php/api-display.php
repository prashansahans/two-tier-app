...
$data = array("jwt" => $OCP_TOKEN, "role" => "frontend-mysql");
...
curl_setopt($ch, CURLOPT_URL, 'https://vault-vaulttest4.router.default.svc.cluster.local/v1/secret/vault-frontend-mysql');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');


$headers = array();
$headers[] = 'X-Vault-Token: _ENV["X_VAULT_TOKEN"]';
curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
