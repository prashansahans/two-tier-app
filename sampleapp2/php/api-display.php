...
$pemFile = tmpfile();
fwrite($pemFile, "cert.pem");//the path for the pem file
...
//curl_setopt($ch, CURLOPT_CAINFO, '/opt/app-root/src/sampleapp2/php/cert.pem'); 
...
//curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,0);
//curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,1);
//url_setopt($ch,CURLOPT_CAINFO,"/opt/app-root/src/sampleapp2/php/router-default-svc-cluster-local.pem");
